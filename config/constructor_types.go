...
var (
	...
	compressionType = reflect.TypeOf((*compression.CompressedTransport)(nil)).Elem()
...
var argTypes = map[reflect.Type]constructor{
	...
	compressionType: func(h host.Host, u *tptu.Upgrader, cg connmgr.ConnectionGater) interface{} { return u.Compression },
