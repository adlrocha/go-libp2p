...
require (
	...
	github.com/libp2p/go-conn-compression-multistream v0.0.0-00010101000000-000000000000
...
replace github.com/libp2p/go-libp2p-gzip => github.com/adlrocha/go-libp2p-gzip v0.0.0-20201007104309-ca8e8cc051b8
